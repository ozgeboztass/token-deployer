      ...
      <div className="container px-5 py-24 mx-auto flex ">
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col w-full mx-auto md:ml-0 relative z-10 shadow-md">
          ...
          <div className="relative mb-4">
            <label htmlFor="email" className="leading-7 text-sm text-[#C6C6C6]">
              Token Name
            </label>
            <input
              type="text"
            ...
            />
            <p className="text-xs text-[#7A6999] mt-1">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full bg-white rounded border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
            <p className="text-xs text-[#7A6999] mt-1">Insert the premint.</p>
          </div>
          <div className="relative mb-4">
          ...
          {ABI != null ? (
            <>
              ...
              <center>
                <button
                  className="inline-flex text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none rounded text-xs text-right"
                  onClick={() => {
                    navigator.clipboard.writeText(ByteCode);
                    Swal.fire("Copied Bytecode!", "", "success");
                  }}
                >
                  Bytecode
                </button>
                <button
                  className="ml-4 inline-flex text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none rounded text-xs"
                  onClick={() => {
                    navigator.clipboard.writeText(ABI);
                    Swal.fire("Copied ABI!", "", "success");
                  }}
                >
                  ABI
                </button>
                <button
                  ...
                  onClick={() => {
                    ...
                    Swal.fire("Copied Contract!", "", "success");
                  }}
                >
                  Contract
                </button>
